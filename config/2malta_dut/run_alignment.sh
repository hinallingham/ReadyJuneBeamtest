...
GEOM_BEAMCHECK="${GEOM_DIR}/2maltaDUT_beamcheck_masked.conf"
...
box_done "Phase 3.5 complete. QC plots: ${CORR2D_PNG}  ${RESIDUALS_PNG}"
echo ""
...
box_done "All pipelines complete. Prealignment -> Alignment -> QC done."
box_done "Correlation2D : ${CORR2D_PNG}"
box_done "Residuals     : ${RESIDUALS_PNG}"
echo -e "${CLR_DONE}=====================================================================${CLR_RESET}"
...
box_done "Discord notification sent."